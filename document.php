                ...
                while ($row = $statement->fetch(PDO::FETCH_ASSOC))
                    {
                        ...
                        if ($user == $user_id) {
                            echo "<a href= 'delete-comment.php?user=$user_id&comment=$comment_id' style='width: 30px; height: 30px border: 1px solid gray; position: absolute; right: 5px; top: 5px'>Delete Comment</a>";
                        }
                        echo "</div>";
                    }
                ?>
